...
<%
  ...
  select case trim(ucase(strStatus))
    case "INC"
      strMsg = "Solicitação cadastrada com Sucesso"
    case "ALT"
      strMsg = "Solicitação alterada com Sucesso"
    case "EXC"
      strMsg = "Solicitação excluída com Sucesso"
    case else
      strMsg = ""
  end select
%>
        ...
        <div class="box-body">
          <table id="table_empresa" class="table table-bordered table-hover">
            ...
            <tr>
              ...
              <td>
                <a data-href="exc_solicitacao.asp?id=<%=ObjRst("id_transacao")%>" class="btn btn-danger" data-toggle="modal" data-target="#confirm-delete" alt="Excluir Solicitação" title="Excluir Solicitação"><i class="glyphicon glyphicon-remove"></i></a>
              </td>
            </tr>
          <%
            ObjRst.MoveNext()
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header clearfix text-left">
            ...
            <h5>Confirmação <span class="semi-bold">da Exclusão</span></h5>
          </div>
          <div class="modal-body">
            <p>Confirmar a exclusão da solicitação?</p>
          </div>                
